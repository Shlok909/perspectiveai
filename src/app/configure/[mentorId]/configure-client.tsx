...
import { ArrowLeft, Bot, BookOpen, BrainCircuit, Loader2, AlertTriangle } from 'lucide-react';
    ...
    <div className="container mx-auto max-w-2xl py-8 md:py-12">
      ...
      <Card className="w-full shadow-lg">
        ...
        <CardContent className="space-y-8">
          {mentorProfile.isFictional && (
            <Alert variant="destructive" className="bg-amber-50 border-amber-200 text-amber-900">
              <AlertTriangle className="h-4 w-4 !text-amber-500" />
              <AlertTitle>Fictional Character</AlertTitle>
              <AlertDescription>
                You are about to chat with a fictional character. The responses are generated by an AI and are based on the character's persona from their respective stories.
              </AlertDescription>
            </Alert>
          )}
